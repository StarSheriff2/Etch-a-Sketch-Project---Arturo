...
This virtual sketch board was built entirely from sractch. I used JS, HTML and CSS to build it. You can also change the pixel density of your brush by clicking on **clear canvas**.
...
4. If you want to increase or decrease the pixel density of your paintbrush, click on *clear canvas* and type any number between 1 and 200
